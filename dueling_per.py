...
class Shallow_Q_Learner(object):
    def __init__(self, state_shape, action_shape, learning_rate=0.005,gamma=0.98, memory=Memory(capacity=2000)):
        ...
        self.Q = DQNAgent().build_dueling_model(self.state_shape[0], self.action_shape, 0.01,0.01 )
        self.tQ = DQNAgent().build_dueling_model(self.state_shape[0], self.action_shape, 0.01,0.01 )
    ...
    def remember(self, error, experience):
